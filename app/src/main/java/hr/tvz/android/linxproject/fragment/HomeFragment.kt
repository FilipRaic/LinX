...
import hr.tvz.android.linxproject.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    private fun prepareItems(view: View) {
        ...
        val items: Call<MutableList<Product>> = client.fetchFavoriteModel()
        ...
        items.enqueue(object : Callback<MutableList<Product>> {
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    recyclerView = view.findViewById(R.id.home_list_pane)
