...
class GpuFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_gpu, container, false)
        prepareItems(view)
        return view
    }
    ...
    private fun prepareItems(view: View) {
        ...
        val items: Call<MutableList<Product>> = client.fetchGpuModel()
        ...
        items.enqueue(object : Callback<MutableList<Product>> {
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    recyclerView = view.findViewById(R.id.gpu_list_pane)
            ...
            override fun onFailure(call: Call<MutableList<Product>>, t: Throwable) {
                Toast.makeText(this@GpuFragment.context, t.message, Toast.LENGTH_LONG).show()
            }
        })
    }
}